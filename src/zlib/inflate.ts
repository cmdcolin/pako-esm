...
import { Buf16, Buf32, Buf8, arraySet } from '../utils/common.ts'
...
export class InflateState {
  ...
  distcode: Int32Array | null = null /* starting table for distance codes */
  ...
  next: Int32Array | null = null /* next available space in codes[] */

  lens = Buf16(320) /* temporary storage for code lengths */
  work = Buf16(288) /* work area for code table building */

  /*
   because we don't have pointers in js, we use lencode and distcode directly
   as buffers so we don't need codes
  */
  //codes = Buf32(ENOUGH);       /* space for code tables */
...
var lenfix: Int32Array, distfix: Int32Array // We have no pointers in JS, so keep tables separate
